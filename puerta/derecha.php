...
<body>
  ...
  <div class="two-columns">
    <form class="contact_form" action="izquierda.php" method="post" enctype="multipart/form-data" onsubmit="return enviar();">

      <ul>
        <li>
          <label for="destino" id="titulo">¿PUERTA DERECHA?</label>
          <div class="wrap">
            <label id="lab">
