<?php
  ...
  if (isset($_SESSION['usuario'])) {
    ...
    if ($ultimoRol ==  null || $ultimoRol == false) {
      $nuevoRol = $rol -> nuevoRol('PUERTA', $usuario['user'], $fecha, $hora);
      ...
      if ($nuevoRol == null || $nuevoRol == false) {
        ...
        //si se guarda bien entramos al rol de puerta
        ?>
          <script type="text/javascript">
            window.location = './puerta/bastidor.php';
          </script>
        <?php
      }
    }
