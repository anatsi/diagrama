...
<body>
  ...
  <div class="two-columns">
    <p style="font-weight: bold; font-size:16px; float: right;">REALLOCATION</p>
    <form class="contact_form" action="destino.php" method="post" enctype="multipart/form-data">
      <ul>
        <li>
          ...
          <input type="text" id="bastidor" name="bastidor" autofocus required pattern="([W|N][F|M][a-zA-Z0-9]{8}[A-Z]{2}[0-9]{5})|([A-Z]{2}[0-9]{5}[A-Z]{1})|([A-Z]{2}[0-9]{5})"/>
        </li>
      </ul>
  </div>
  <div class="botones">
