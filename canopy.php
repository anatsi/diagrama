<?php
  ...
  if (isset($_SESSION['usuario'])) {
    ...
    if ($ultimoRol ==  null || $ultimoRol == false) {
      $nuevoRol = $rol -> nuevoRol('CANOPY', $usuario['user'], $fecha, $hora);
      ...
      if ($nuevoRol == null || $nuevoRol == false) {
        ...
        //si se guarda bien entramos al rol de canopy
        ?>
          <script type="text/javascript">
            window.location = './canopy/origen.php';
          </script>
        <?php
      }
    }
