...
<body onload="inicio();">
  ...
  <div class="two-columns">
    <form class="contact_form" action="guardarMovimientos.php" method="post" enctype="multipart/form-data" onsubmit="return enviar();">
      ...
      <ul>
        <li>
          ...
          <select class="" name="otrosDestinos" id="otro" onchange="bloquear2();">
             ...
             <option value="MORERAS" onchange="bloquear2();">MORERAS</option>
             <option value="CARPA" onchange="bloquear2();">CARPA</option>
      ...
      <?php
      //recogemos los datos de origen bastidos y fechas que ya habiamos sacado en inputs para pasarlo a la siguiente pagina
