...
<body>
  ...
  <div class="two-columns">
    <form class="contact_form" action="guardar.php" method="post" enctype="multipart/form-data" onsubmit="return enviar();">
      ...
      <ul>
        <li>
          <label for="destino" id="titulo">¿AULLIDO?</label>
          <div class="wrap">
            <label id="lab">
              <input type="radio" id="opcion1" name="aullido" value="OK" onclick="desbloquear();">
               <div  class="btn btn-sık"><span>OK</span></div>
            </label>
            <label id="lab">
              <input  type="radio" id="opcion2" name="aullido" value="SOSPECHOSO" onclick="desbloquear();">
