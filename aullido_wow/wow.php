...
<body>
  ...
  <div class="two-columns">
    <form class="contact_form" action="guardar.php" method="post" enctype="multipart/form-data" onsubmit="return enviar();">
      ...
      <ul>
        <li>
          <label for="destino" id="titulo">¿WOW?</label>
          <div class="wrap">
            <label id="lab">
              <input type="radio" id="opcion1" name="wow" value="OK" onclick="desbloquear();">
               <div  class="btn btn-sık"><span>OK</span></div>
            </label>
            <label id="lab">
              <input  type="radio" id="opcion2" name="wow" value="SOSPECHOSO" onclick="desbloquear();">
             <div class="btn btn-sık"><span>SOSPECHOSO</span></div>
           </label>
        </div>
      </li>
    </ul>
      ...
      //guardamos los datos del formulatio anterior en inputs para pasarlos al siguiente
        ...
        echo "<input type='hidden' name='aullido' value='".$_POST['aullido']."'>";
