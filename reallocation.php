<?php
  ...
  if (isset($_SESSION['usuario'])) {
    ...
    if ($ultimoRol ==  null || $ultimoRol == false) {
      $nuevoRol = $rol -> nuevoRol('REALLOCATION', $usuario['user'], $fecha, $hora);
      ...
      if ($nuevoRol == null || $nuevoRol == false) {
        ...
        //si se guarda bien entramos al rol de radio
        ?>
          <script type="text/javascript">
            window.location = './reallocation/bastidor.php';
          </script>
        <?php
      }
    }
    ...
    //si la sesion no esta iniciada, volvemos a la pantalla de iniciar sesion
    ?>
      <script type="text/javascript">
