...
// comprobamos si el bastidor se ha escaneado bien
  if(isset($_POST['construccion']) && isset($_POST['bastidor'])){
...
<body>
  ...
  <div class="two-columns">
    <form class="contact_form" action="ruido.php" method="post" enctype="multipart/form-data" onsubmit="return enviar();">

      <ul>
        <li>
          <label for="destino" id="titulo">MODELO</label>
          <div class="wrap">
            <label id="lab">
              <input type="radio" id="opcion1" name="tamano" value="SWB">
               <div  class="btn btn-sık"><span>SWB</span></div>
            </label>
            <label id="lab">
              <input  type="radio" id="opcion2" name="tamano" value="LWB">
             <div class="btn btn-sık"><span>LWB</span></div>
           </label>
           <label id="lab">
             <input  type="radio" id="opcion3" name="tipo" value="KOMBI">
            <div class="btn btn-sık"><span>KOMBI</span></div>
          </label>
          <label id="lab">
            <input  type="radio" id="opcion4" name="tipo" value="VAN">
           <div class="btn btn-sık"><span>VAN</span></div>
         </label>
        </div>
      </li>
    </ul>
