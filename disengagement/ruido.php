...
// comprobamos si el bastidor se ha escaneado bien
  if(isset($_POST['tamano']) && isset($_POST['tipo'])){
...
<body>
  ...
  <div class="two-columns">
    <form class="contact_form" action="medicion.php" method="post" enctype="multipart/form-data" onsubmit="return enviar();">
          ...
          <div class="wrap">
            <label id="lab">
              <input type="radio" id="opcion1" name="ruido" value="DERECHA">
               <div  class="btn btn-sık"><span>IZQUIERDA</span></div>
            </label>
            <label id="lab">
              <input  type="radio" id="opcion2" name="ruido" value="IZQUIERDA">
             <div class="btn btn-sık"><span>DERECHA</span></div>
           </label>
           <label id="lab">
             <input  type="radio" id="opcion3" name="ruido" value="REPARADO">
            <div class="btn btn-sık"><span>REPARADO</span></div>
          </label>
        </div>
      </li>
    </ul>
